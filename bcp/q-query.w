...
&Scoped-define INTERNAL-TABLES testeJson

/* Definitions for QUERY Query-Main                                     */
&Scoped-define QUERY-STRING-Query-Main FOR EACH testeJson NO-LOCK
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH testeJson NO-LOCK.
&Scoped-define TABLES-IN-QUERY-Query-Main testeJson
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main testeJson
...
/* Query rebuild information for QUERY Query-Main
     ...
     _Options          = "NO-LOCK"
     _Design-Parent    is WINDOW q-tables @ ( 1.17 , 6.29 )
*/  /* QUERY Query-Main */
&ANALYZE-RESUME
